...
function Sidebar({ isOpen, onClose }) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        { id: 'enrollment-trends', name: 'Enrollment Trends', icon: MdTrendingUp, path: '/admin/analytics/trends' },
    ...
    },
    {
      ...
      icon: MdBook,
      submenu: [
        { id: 'courses', name: 'Course Programs', icon: MdLocalLibrary, path: '/admin/courses' },
        { id: 'batches', name: 'Batch Management', icon: MdGroup, path: '/admin/batches' },
        { id: 'tesda-vouchers', name: 'TESDA Vouchers', icon: MdCardGiftcard, path: '/admin/tesda' }
      ]
    },
    {
      id: 'reports',
