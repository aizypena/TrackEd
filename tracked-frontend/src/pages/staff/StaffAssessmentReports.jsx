...
const StaffAssessmentReports = () => {
  ...
  const generateReport = async () => {
    ...
    try {
      ...
      const response = await fetch('https://api.smitracked.cloud/api/staff/reports/assessments', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
        ...
        <nav className="bg-tracked-primary text-white p-4">
          <div className="container mx-auto flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold">Assessment Reports</h1>
                <p className="text-sm text-blue-100">Generate and export assessment and competency reports</p>
              </div>
            </div>
            {reportData && (
              <button
